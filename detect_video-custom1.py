...
def main(_argv):
    ...
    while True:
        ...
        # to enable the disinfecting function-------------------------------------------------------------------------
        class_checker = list(class_names.values())
        class_key = (key)
        for i in class_checker:
            if (i == class_key):
                print("Object Detected")
                cv2.putText(frame, "Disinfecting: {}".format(key), (2, 50), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (255, 0, 0), 2)
                #------------------------ add code here to activate the disinfecting fuction --------------------------

                #------------------------------------------------------------------------------------------------------
            else:
                print("--------------------------No Object Detected--------------------------")
                #------------------------ add code here to keep the system on scanning the room------------------------
